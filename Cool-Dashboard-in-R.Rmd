...
df <- read_csv('C:/Users/mwand/Documents/Cool Dashboards in R/bestsellers with categories.csv')
...
data <- read_csv('C:/Users/mwand/Documents/Cool Dashboards in R/Billboard top 100 Charts.csv')
glimpse(data)
data <- data %>% 
